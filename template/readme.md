...
1. Develop component(s) in isolation using storybook and stories `npm run storybook`
2. run tests `npm run test`
3. Compose component(s) in the context of a card `npm start`
4. Deploy card(s) to Experience Dashboard `npm run deploy-dev`
5. Configure card(s) in Experience Dashboard
6. Repeat steps 1-5 as needed
7. Create a PR for your changes

Commit changes often and push to your repository.  This will allow you to easily rollback changes if needed.
